...
img_1 = os.path.join(res_folder, 'grey.png')
img_2 = os.path.join(res_folder, 'grey_s.png')
img_3 = os.path.join(res_folder, 'green.png')
img_4 = os.path.join(res_folder, 'brown.png')
img_5 = os.path.join(res_folder, 'warm_g.png')
img_6 = os.path.join(res_folder, 'grey_d.png')   
...
color = [[132,124,137], [188,165,165], [185,187,165], [176,157,136], [194,190,178], [86,86,98]]
names = ['grey', 'grey 2', 'green', 'brown', 'grey 3', 'grey 4']
...
def main():
    try:
        ...
        btn_another = tk.Button(window, text = 'Choose another file', font = ('Arial', 13), bg = 'white', command = another).pack()
        photopath = filedialog.askopenfilename()
    except: 
